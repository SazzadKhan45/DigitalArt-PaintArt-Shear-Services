...
const AddArtwork = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //Post art works
    axios
      .post("https://color-nest-server.vercel.app/explore-art", artInfo)
      .then((res) => {
          ...
          <div className=" md:flex justify-between items-center md:gap-4">
            ...
            <div className="md:w-1/2 mb-4 md:mb-0">
              ...
              <input
                ...
                readOnly
                className="w-full border border-gray-300 bg-gray-100 text-gray-600 rounded-lg px-4 py-2 outline-none cursor-not-allowed"
              />
            </div>
